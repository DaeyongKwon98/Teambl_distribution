...
export default function FriendOtherItem({ id, friendInfo }) {
  ...
  return (
    ...
    >
      ...
      <div className="friendOtherItem-info-container">
        <span className="friendOtherItem-name">{friendInfo.user_name}</span>
        <div className="friendOtherItem-basic-info-container">
          <span className="friendOtherItem-info right-margin-10px">
            {friendInfo.school}
          </span>
          <span className="friendOtherItem-info font-12px">{"|"}</span>
        ...
        <div className="friendOtherItem-basic-info-container">
          ...
          {friendInfo.major2 && friendInfo.major2 !== "" && (
            <>
              ...
              <span className={"friendOtherItem-info left-margin-3px"}>
                {friendInfo.major2}
              </span>
            </>
          )}
