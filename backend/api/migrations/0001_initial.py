# Generated by Django 5.0.7 on 2024-09-20 14:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.ManyToManyField(blank=True, to='api.keyword')),
                ('people_list', models.ManyToManyField(blank=True, related_name='participating_projects', to=settings.AUTH_USER_MODEL)),
